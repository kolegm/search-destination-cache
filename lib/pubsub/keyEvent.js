...
KeyEventClient.prototype._initClient = function (options) {
  this._receiver = this._getClient(options);
  this._receiver.setMaxListeners(0);
   ...
   */
  this._receiver.config('set', 'notify-keyspace-events', 'Ex');
};
...
KeyEventClient.prototype._checkReceiver = function () {
  return _.isObject(this._receiver);
};
