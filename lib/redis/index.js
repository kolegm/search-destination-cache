/**
 * RedisClient for work with redis as singleton
 *
 * Using:
 *  require('./').getInstance({
...
RedisClient.prototype._useOptions = function (_options) {
...
RedisClient.prototype._checkOptions = function () {
  return _.isObject(this.options);
}

RedisClient.prototype._checkOptionsWithException = function () {
...
RedisClient.prototype._getOptions = function () {
  this._checkOptionsWithException();

  return _.extend({}, this.options);
}

RedisClient.prototype._checkClient = function () {
  return _.isObject(this.client);
}

RedisClient.prototype._checkClientWithException = function () {
